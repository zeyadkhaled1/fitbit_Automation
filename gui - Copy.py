...
class Ui_MainWindow(object):
    ...
    def submitButton1(self):
        ...
        # Automation process
        try:
            for index,email in enumerate(self.data.table1_emails):
                ...
                self.set_progress1(int(index/len(self.data.table1_emails)))
        except:
            pass
        # 
    ...
    def submitButton2(self):
        ...
        for index,email in enumerate(self.data.table2_emails):
            ...
            main_fill_form(self.data.first_name2,self.data.last_name2,self.data.address_line1,self.data.address_line2,str(self.data.postcode),self.data.city,self.data.state,email,self.data.payment_email,str(self.data.phone),self.data.address_line1)
            self.set_progress2(int(index/len(self.data.table2_emails)))
        self.delete_from_table2()
        self.set_progress2(0)
