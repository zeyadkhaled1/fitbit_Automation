...
def generate_taiwan_phone_number():
  area_code = random.choice(['02', '03', '04', '05', '06', '07', '08', '09']) # Taiwan area codes
  middle_part = str(random.randint(1000000, 9999999))
  return area_code + middle_part

def generate_taiwanese_address():
  cities = ['Taipei', 'New Taipei', 'Taichung', 'Tainan', 'Kaohsiung', 'Taoyuan', 'Hsinchu', 'Miaoli', 'Changhua', 'Nantou', 'Yunlin', 'Chiayi', 'Pingtung', 'Yilan', 'Hualien', 'Taitung', 'Penghu', 'Kinmen', 'Lienchiang']
  districts = ['Zhongzheng', 'Datong', 'Zhongshan', 'Songshan', 'Daan', 'Wanhua', 'Xinyi', 'Shilin', 'Beitou', 'Neihu', 'Nangang', 'Wenshan', 'Banqiao', 'Xinzhuang', 'Tucheng', 'Shulin', 'Yingge', 'Sanchong', 'Zhonghe', 'Tamsui', 'Ruifang', 'Gongliao', 'Pingxi', 'Shuangxi', 'Jinshan', 'Wulai', 'Xizhi', 'Sanxia', 'Shiding', 'Yonghe', 'Xindian', 'Renai', 'Xinyi', 'Xitun', 'Nantun', 'South District', 'North District', 'East District', 'West District', 'Anping', 'Yongkang', 'Rende', 'Guanmiao', 'Longqi', 'Guiren', 'Jiali', 'Xinying', 'Liuying', 'Madou', 'Jiangjun', 'Nansi', 'Yanshui', 'Houbi', 'Baihe', 'Dongshan', 'Zhuqi', 'Meishan', 'Fanlu', 'Dapu', 'Minxiong', 'Xiluo', 'Erlin', 'Shuishang', 'Alishan', 'Douliu', 'Huwei', 'Lunbei', 'Mailiao', 'Budai', 'Linnei', 'Taibao', 'Xinyuan', 'Zhutian', 'Puzi', 'Jhutian', 'Fanlu', 'Dounan', 'Jiji', 'Shuili', 'Yuchi', 'Renai', 'Luye', 'Guanshan', 'Chenggong', 'Ruisui', 'Fenglin', 'Changbin', 'Taimali', 'Dawu', 'Ludao', 'Jincheng', 'Nangan']
  streets = ['Main St', 'Park Rd', 'Lincoln Blvd', 'Maple St', 'Oak St', 'Pine Ave', 'Cedar Blvd', 'Elm St', 'Washington Ave', 'Madison St', 'Jefferson Ave', 'Roosevelt Rd', 'Fuxing S Rd', 'Zhongxiao E Rd', 'Chung Shan N Rd', 'Beiping E Rd', 'Hsin Yi Rd', 'Xinsheng S Rd', 'Guangfu S Rd', 'Minquan E Rd', 'Nan Jing E Rd']
  city = random.choice(cities)
  district = random.choice(districts)
  street = random.choice(streets)
  building_number = str(random.randint(1, 999))
  address_line_1 = f'{street} {building_number}'
  address_line_2 = f'{district}, {city}'
  postal_code = f'{random.randint(100, 999)}{random.randint(1, 99)}'
  return  address_line_1,address_line_2,postal_code,district,city
...
def generate_japanese_address():
  ...
  street = random.choice(streets)
  house_number = str(random.randint(1, 999))
  address_line_1 = f'{street} {house_number}'
  address_line_2 = f'{city}, {prefecture}'
  zip_code = str(random.randint(10000, 99999))
    ...
    try:
      ...
      if country=='Japan':
          ...
          page.get_by_label("Country").select_option(value='GB')
           ...
           page.get_by_label("Country").select_option(value='TW')
      ...
      if country=='Japan':
          ...
          page1.get_by_role("option", name="Taiwan (台灣)+886").click()
          page.wait_for_timeout(2000)
          page1.get_by_role("textbox", name="Phone Number").click()
          page.wait_for_timeout(2000)
          page1.get_by_role("textbox", name="Phone Number").type(phone_number)
      page1.get_by_role(
