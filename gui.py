...
from fitbit_Account import generate_year_of_birth,generate_Japanese_name,generate_pounds,generate_centimeters,main_account_creation,generate_password,generate_English_name,generate_Taiwan_name
from fitbit_Form import generate_japanese_address,generate_japanese_phone_number,main_fill_form,generate_uk_address,generate_uk_phone_number,generate_taiwan_phone_number,generate_taiwanese_address
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def retranslateUi(self):
        ...
        self.country.setItemText(2, _translate("self", "Taiwan"))
        ...
        self.country_tab2.setItemText(2, _translate("self", "Taiwan"))
    ...
    def current_text_changed_country_tab2(self):
        if (self.country_tab2.currentText() == "United Kingdom"):
            self._extracted_from_current_text_changed_country_tab2_3(
                "MasterCard Debit Card", True
            )
        elif self.country_tab2.currentText() =="Japan":
            self._extracted_from_current_text_changed_country_tab2_3(
                "Google eGifts", False
            )
        elif self.country_tab2.currentText() == 'Taiwan':
            self._extracted_from_current_text_changed_country_tab2_3(
                "MasterCard Debit Card", False
            )

    # TODO Rename this here and in `current_text_changed_country_tab2`
    def _extracted_from_current_text_changed_country_tab2_3(self, arg0, arg1):
        self.paymentMethod.setItemText(1, arg0)
        self.State.setDisabled(arg1)
        self.ch4.setDisabled(arg1)
    ...
    def submitButton1(self):
        ...
        try:
            for email in self.data.table1_emails:
                ...
                elif (self.ch9.checkState() and self.data.country =='Taiwan'):
                    self.data.first_name1=generate_Taiwan_name()
                else:
                ...
                elif (self.ch10.checkState() and self.data.country =='Taiwan'):
                    self.data.last_name1=generate_Taiwan_name()
                else:
    ...
    def submitButton2(self):
        ...
        for email in self.data.table2_emails:
            ...
            if self.country_tab2.currentText() == "Japan":
                ...
                address_line_1,address_line_2,zip_code,city,prefecture=generate_taiwanese_address()
            ...
            elif (self.ch1.checkState() and self.country_tab2.currentText() == "Taiwan"):
                        self.data.first_name2=generate_Taiwan_name()
            else:
            ...
            elif (self.ch5.checkState() and self.country_tab2.currentText() == "Taiwan"):
                        self.data.last_name2=generate_Taiwan_name()          
            else:
            ...
            if (self.ch8.checkState() and self.country_tab2.currentText()=='Japan'):
                        self.data.phone=generate_japanese_phone_number()
            elif (self.ch8.checkState() and self.country_tab2.currentText()=='United Kingdom'):
                        self.data.phone=generate_uk_phone_number()
            elif (self.ch8.checkState() and self.country_tab2.currentText()=='Taiwan'):
                        self.data.phone=generate_taiwan_phone_number()
            else:
